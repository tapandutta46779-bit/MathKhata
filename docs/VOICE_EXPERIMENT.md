...
The practical optional model investigation, including download, privacy, WebGPU/WASM, adaptation, and evaluation gates, is recorded in [LOCAL_MODEL_PATH.md](LOCAL_MODEL_PATH.md). No custom voice or language model has been trained in Stage 1.
